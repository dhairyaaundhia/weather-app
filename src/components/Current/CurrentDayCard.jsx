...
export default function CurrentDayCard() {
  ...
  return (
    <div
      className='relative z-0 grid grid-cols-1 gap-y-3 md:gap-y-0 gap-x-0 md:gap-x-3 md:grid-cols-2   delay-200 duration-700 transform opacity-0 transition-all translate-y-12 ease-out'
      data-replace='{ "translate-y-12": "translate-y-0", "opacity-0": "opacity-100" }'
    >
      <div className='relative border-[3px] bg-[#282c34] dark:bg-slate-700 dark:border-slate-900 col-span-2 h-fit w-full grid grid-cols-2 sm:grid-cols-4 grid-rows-2 justify-center items-center px-5 sm:px-10'>
